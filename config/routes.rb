H1movies::Application.routes.draw do
  ...
  match 'cines/updateshowtimes' => 'cines#updateShowtimes'  
  match 'cines/wheretowatch/:movie_id' => 'cines#whereToWatch'  
  ...
  match 'cines/findwhere/:latitud/:longitud/:movie_id' => 'cines#findNear', :constraints => { :latitud => /[\-0-9\.]+/, :longitud => /[\-0-9\.]+/ }          
